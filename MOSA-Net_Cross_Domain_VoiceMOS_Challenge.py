...
def train_data_generator(file_list, file_list_hubert):
	index=0
        data_path ='./data/phase1-main/DATA/wav/'
	while True:
...
def val_data_generator(file_list, file_list_hubert):
	index=0
        data_path ='./data/phase1-main/DATA/wav/'
	while True:
         mos_filepath=file_list[index].split(',')
...
def train(Train_list, Train_list_hubert, Num_train, Test_list, Test_list_hubert, Num_testdata, pathmodel):
    ...
    print 'training...'
    g1 = train_data_generator(Train_list, Train_list_hubert)
    g2 = val_data_generator  (Test_list, Test_list_hubert)
...
if __name__ == '__main__':  
    ...
    Val_list_hubert = ListRead('./data/phase1-main/DATA/sets/List_Npy_Val_hubert_MOS_Challenge_phase1_main.txt')
    ...
    if args.mode == 'train':
       print 'training' 
       train(Train_list, Train_list_hubert, NUM_DATA_TRAIN, Val_list, Val_list_hubert, NUM_DATA_VAL, pathmodel)
       print 'complete training stage'    
    if args.mode == 'test':    
       print 'testing' 
       Test(Test_List, Test_List_Hubert_feat,pathmodel)
